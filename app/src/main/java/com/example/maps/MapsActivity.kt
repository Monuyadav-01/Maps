...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onStart() {
        ...
        when {
            isFineLocationGranted() -> {
                when {
                    isLocationEnabled() -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
    ...
    private fun setupLocationListener() {
        ...
        val locationRequest = com.google.android.gms.location.LocationRequest().setInterval(2000)
            .setFastestInterval(2000).setSmallestDisplacement(2f)
                ...
                override fun onLocationResult(locationResult: LocationResult) {
                    ...
                    for (location in locationResult.locations) {
                        ...
                        if (::mMap.isInitialized) {
                            mMap.addMarker(
                                MarkerOptions().position(current).title("Marker in Current Are")
                            )
